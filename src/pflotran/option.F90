...
!   table lookup
    ...
    PetscBool :: cur_waypoint_update_conditions
    PetscInt :: novp_root_sys
    PetscInt :: nglb_root_sys
    PetscBool :: root_system
...
! option%idt_switch = 1
  ...
  option%novp_root_sys = 1
  option%nglb_root_sys = -1
  option%root_system = PETSC_FALSE
