...
#include "finclude/petscsys.h"
  ...
  type, public :: output_option_type
    ...
    PetscBool :: print_root_system
    PetscInt,pointer :: root_system_ids(:)
...
function OutputOptionCreate()
  ...
  output_option%print_root_system = PETSC_FALSE
  nullify(output_option%root_system_ids)
...
subroutine OutputOptionDestroy(output_option)
  ...
  if (associated(output_option%root_system_ids)) deallocate(output_option%root_system_ids)
  nullify(output_option%root_system_ids)
